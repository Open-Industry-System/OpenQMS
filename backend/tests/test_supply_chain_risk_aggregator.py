...
async def test_open_scar_count_time_point_logic(db, test_user):
    ...
    db.add(SupplierSCAR(
        scar_id=uuid4(), scar_no="SCAR-TEST-001", supplier_id=supplier.supplier_id,
    ...
    db.add(SupplierSCAR(
        scar_id=uuid4(), scar_no="SCAR-TEST-002", supplier_id=supplier.supplier_id,
    ...
    db.add(SupplierSCAR(
        scar_id=uuid4(), scar_no="SCAR-TEST-003", supplier_id=supplier.supplier_id,
