...
Revises: 20260715_fix_waiver_check
...
down_revision chains after 20260715_fix_waiver_check (parent branch head at
the time of merge) so merge into feature/us-e2e-01-spec-a keeps a single
alembic head.
"""
from alembic import op

revision = "20260715_fmea_linkage_indexes"
down_revision = "20260715_fix_waiver_check"
branch_labels = None
depends_on = None
