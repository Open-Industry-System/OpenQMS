...
Expected: 单 head `20260708_d7_node_action_status (tenant, platform) (head)`。若 01.3 状态机切片已新增迁移导致 head 变化，把 Step 5 迁移文件的 `down_revision` 接到**当前真实 head**。本计划以下假设 head 仍为 `20260708_d7_node_action_status`。
