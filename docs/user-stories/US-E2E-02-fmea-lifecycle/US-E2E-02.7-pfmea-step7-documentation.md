...
**关联 skill**: `verify-fmea-lifecycle-pfmea-step7-documentation`
...
**作为** 前期策划质量工程师，**我想** 在向导 Step7 汇总评审全部 6 步内容，确认完成后跳转编辑器，
...
| 失败条件（FAILED） | wizard_completed 未置 true；前序步骤有空段未拦截；跳转失败；未审计 |
